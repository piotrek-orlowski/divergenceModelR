...
Rcpp::List affineObservationStateHandler_D(const arma::mat& stateMat, const Rcpp::List& modelParameters, const int iterCount){
  ...
  arma::mat yhat(1+U*T,stateMat.n_cols);
  ...
  // Handle the noise covariance matrix. The stock ``observation'' noise is
  // uncorrelated with portfolio observation noise.
  arma::mat obsNoiseMat(1+U*T,1+U*T,arma::fill::zeros);
  obsNoiseMat(0,0) = stockNoise(0,0);
...
Rcpp::List affineObservationStateHandler_DS(const arma::mat& stateMat, const Rcpp::List& modelParameters, const int iterCount){
  ...
  arma::mat yhat(1+U*T*2,stateMat.n_cols);
  ...
  // Handle the noise covariance matrix. The stock ``observation'' noise is
  // uncorrelated with portfolio observation noise.
  arma::mat obsNoiseMat(1+2*U*T,1+2*U*T,arma::fill::zeros);
  obsNoiseMat(0,0) = stockNoise(0,0);
